...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/objectAccess/${targetComponent.props.objectAccess.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/objectAccess/${targetComponent.props.objectAccess.id}/permission`}>
...
const internalSummaryOf = (objectAccess, targetComponent) => {
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="访问对象类型" style={{ wordBreak: 'break-all' }}>
        {objectAccess.objectType}
      </Description>
      <Description term="列表1" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list1}
      </Description>
      <Description term="列表2" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list2}
      </Description>
      <Description term="列表3" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list3}
      </Description>
      <Description term="列表4" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list4}
      </Description>
      <Description term="列表5" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list5}
      </Description>
      <Description term="列表6" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list6}
      </Description>
      <Description term="列表7" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list7}
      </Description>
      <Description term="列表8" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list8}
      </Description>
      <Description term="列表9" style={{ wordBreak: 'break-all' }}>
        {objectAccess.list9}
      </Description>
