...
const menuData = {
  menuName: window.trans('object_access'),
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'objectAccess'),
    sorter: true,
  },
  {
  ...
  return (
    <div key={objectAccess.id}>
      <DescriptionList key={objectAccess.id} size="small" col="2">
        ...
        <Description term={fieldLabels.objectType} style={{ wordBreak: 'break-all' }}>
          {objectAccess.objectType}
        </Description>
        <Description term={fieldLabels.list1} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list1}
        </Description>
        <Description term={fieldLabels.list2} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list2}
        </Description>
        <Description term={fieldLabels.list3} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list3}
        </Description>
        <Description term={fieldLabels.list4} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list4}
        </Description>
        <Description term={fieldLabels.list5} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list5}
        </Description>
        <Description term={fieldLabels.list6} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list6}
        </Description>
        <Description term={fieldLabels.list7} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list7}
        </Description>
        <Description term={fieldLabels.list8} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list8}
        </Description>
        <Description term={fieldLabels.list9} style={{ wordBreak: 'break-all' }}>
          {objectAccess.list9}
        </Description>
        <Description term={fieldLabels.app}>
          <div>
