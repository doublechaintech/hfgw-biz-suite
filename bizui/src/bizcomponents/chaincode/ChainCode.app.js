...
class ChainCodeBizApp extends React.PureComponent {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/chainCode/${this.props.chainCode.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getServiceRecordSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_chainCode', id: state._chainCode.id, 
      referenceName: 'chainCode', 
      listName: 'serviceRecordList', ref:state._chainCode, 
  ...
  getServiceRecordCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._chainCode.serviceRecordSearchFormParameters,
      loading: state._chainCode.loading,
      owner: { type: '_chainCode', id: state._chainCode.id, referenceName: 'chainCode', listName: 'serviceRecordList', ref:state._chainCode, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getServiceRecordUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_chainCode', id: state._chainCode.id, listName: 'serviceRecordList', ref:state._chainCode, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/chainCode/:id/list/serviceRecordCreateForm", component: this.getServiceRecordCreateForm()},
  	{path:"/chainCode/:id/list/serviceRecordUpdateForm", component: this.getServiceRecordUpdateForm()},
   	{path:"/chainCode/:id/ChangeRequestType/:code", component: GlobalComponents.ChangeRequestStepForm},
