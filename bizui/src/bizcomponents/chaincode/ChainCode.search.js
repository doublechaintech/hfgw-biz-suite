  ...
  return (
    <div>
      <ChannelAssociateForm
        ...
        data={{ chainCodeList: selectedRows }}
        owner={owner}
...
class ChainCodeSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { ChainCodeTable } = GlobalComponents;
    const { ChainCodeSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ChainCodeSearchForm {...this.props} />
            </div>
            <div className={styles.tableListOperator}>
        ...
        {showDeletionDialog(this, ChainCodeModalTable, 'chainCodeIds')}
...
export default Form.create()(ChainCodeSearch);
