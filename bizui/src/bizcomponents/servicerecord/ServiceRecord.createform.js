...
import ServiceRecordCreateFormBody from './ServiceRecord.createformbody'
...
class ServiceRecordCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addServiceRecord`,
          payload: { id: owner.id, type: 'serviceRecord', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'serviceRecord',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(ServiceRecordCreateForm))
