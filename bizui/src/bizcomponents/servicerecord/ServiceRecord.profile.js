...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ServiceRecordBase.renderItemOfList(item, targetComponents)

}



class ServiceRecordProfile extends Component {
...
}))(Form.create()(ServiceRecordProfile))
