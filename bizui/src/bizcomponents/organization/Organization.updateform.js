...
import styles from './Organization.updateform.less';
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, organizationId, ...imagesValues };
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateOrganization`,
          payload: {
            id: owner.id,
            type: 'organization',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1;
      dispatch({
        type: `${owner.type}/gotoNextOrganizationUpdateRow`,
        payload: {
          id: owner.id,
          type: 'organization',
          selectedRows,
    ...
    const internalRenderTitle = () => {
      ...
      return (
        <div>
          ...
          组织: {currentUpdateIndex + 1}/{selectedRows.length}
        </div>
      );
    };
...
}))(Form.create()(OrganizationUpdateForm));
