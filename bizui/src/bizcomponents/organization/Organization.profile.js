...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.OrganizationBase.renderItemOfList(item, targetComponents)
...
class OrganizationProfile extends Component {
  ...
  render() {
    ...
    const { id,displayName, nodeCount } = organization
    const  returnURL = `/organization/${id}/dashboard`
    const cardsData = {cardsName:"组织",cardsFor: "organization",cardsSource: organization,displayName,returnURL,
  		subItems: [
...
}))(Form.create()(OrganizationProfile))
