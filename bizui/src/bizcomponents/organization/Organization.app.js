...
class OrganizationBizApp extends React.PureComponent {
  ...
  getNodeSearch = () => {
    ...
    return connect(state => ({
      ...
      listName: 'nodeList', ref:state._organization, 
  ...
  getNodeCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._organization.nodeSearchFormParameters,
      loading: state._organization.loading,
      owner: { type: '_organization', id: state._organization.id, referenceName: 'organization', listName: 'nodeList', ref:state._organization, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(NodeCreateForm)
  }
  ...
  getNodeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_organization', id: state._organization.id, listName: 'nodeList', ref:state._organization, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(NodeUpdateForm)
  }
