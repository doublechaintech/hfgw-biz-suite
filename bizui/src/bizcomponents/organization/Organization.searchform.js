...
import styles from './Organization.search.less';
...
class OrganizationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      organizationList: 1,
      'organizationList.searchField': fieldName,
      'organizationList.searchVerb': 'startsWith',
      'organizationList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          organizationSearchFormParameters: filterObjectKeys(fieldsValue),
            ...
            <Form.Item label={fieldLabels.network}>
              {getFieldDecorator('network', { initialValue: tryinit('network') })(
                <SelectObject
                  ...
                  targetType={'network'}
                  requestFunction={OrganizationService.requestCandidateNetwork}
                  useForSearch
                />
              )}
            </Form.Item>
...
export default Form.create()(OrganizationSearchForm);
