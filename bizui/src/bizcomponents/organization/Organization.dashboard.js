...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/organization/${targetComponent.props.organization.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/organization/${targetComponent.props.organization.id}/permission`}>
...
class OrganizationDashboard extends Component {
  ...
  render() {
    ...
    const { id, displayName, nodeListMetaInfo, nodeCount } = this.props.organization;
    ...
    const cardsData = {
      cardsName: '组织',
      cardsFor: 'organization',
      cardsSource: this.props.organization,
      returnURL,
      displayName,
      subItems: [
        {
