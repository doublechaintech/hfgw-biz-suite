  ...
  return (
    <div>
      <HyperledgerNetworkAssociateForm
        ...
        data={{ organizationList: selectedRows }}
        owner={owner}
...
class OrganizationSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { OrganizationTable } = GlobalComponents;
    const { OrganizationSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <OrganizationSearchForm {...this.props} />
            </div>
            <div className={styles.tableListOperator}>
        ...
        {showDeletionDialog(this, OrganizationModalTable, 'organizationIds')}
...
export default Form.create()(OrganizationSearch);
