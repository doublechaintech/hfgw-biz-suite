...
const internalLargeTextOf = node => {
  return (
    <div>
      <Card title={`Tls Cacert`}>
        <pre>{node.tlsCacert}</pre>
      </Card>
    </div>
  );
};
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/node/${targetComponent.props.node.id}/permission`}>
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '组织',
              'organization',
              NodeService.requestCandidateOrganization,
              NodeService.transferToAnotherOrganization,
              'anotherOrganizationId',
              node.organization ? node.organization.id : ''
            )
          }
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '频道',
              'channel',
              NodeService.requestCandidateChannel,
              NodeService.transferToAnotherChannel,
              'anotherChannelId',
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '类型',
              'nodeType',
              NodeService.requestCandidateType,
              NodeService.transferToAnotherType,
              'anotherTypeId',
      ...
      subItems: [
        {
          ...
          addFunction: true,
          role: 'grpcOption',
          metaInfo: grpcOptionListMetaInfo,
          renderItem: GlobalComponents.GrpcOptionBase.renderItemOfList,
        },
        {
