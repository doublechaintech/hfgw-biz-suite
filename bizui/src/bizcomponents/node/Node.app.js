...
class NodeBizApp extends React.PureComponent {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/node/${this.props.node.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getGrpcOptionSearch = () => {
    ...
    return connect(state => ({
      ...
      referenceName: 'node', 
      listName: 'grpcOptionList', ref:state._node, 
  ...
  getGrpcOptionCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._node.grpcOptionSearchFormParameters,
      loading: state._node.loading,
      owner: { type: '_node', id: state._node.id, referenceName: 'node', listName: 'grpcOptionList', ref:state._node, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getGrpcOptionUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_node', id: state._node.id, listName: 'grpcOptionList', ref:state._node, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
