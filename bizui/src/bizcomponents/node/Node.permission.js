...
import styles from './Node.profile.less'
...
const renderPermissionSetting = node => {
  const {NodeBase} = GlobalComponents
  return <PermissionSetting targetObject={node}  targetObjectMeta={NodeBase}/>
}

const internalRenderExtraHeader = defaultRenderExtraHeader

class NodePermission extends Component {
