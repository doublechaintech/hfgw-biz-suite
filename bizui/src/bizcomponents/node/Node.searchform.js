...
import styles from './Node.search.less';
...
class NodeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      nodeList: 1,
      'nodeList.searchField': fieldName,
      'nodeList.searchVerb': 'startsWith',
      'nodeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'url')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'organization')
      );
      pushIfNotNull(
        paramList,
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'tlsCacert')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'type')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'address')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'contactPerson')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'contactTelephone')
      );
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          nodeSearchFormParameters: filterObjectKeys(fieldsValue),
        ...
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <Form.Item label={fieldLabels.organization}>
              {getFieldDecorator('organization', { initialValue: tryinit('organization') })(
                <SelectObject
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.tlsCacert}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.contactPerson}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.contactTelephone}>
...
export default Form.create()(NodeSearchForm);
