...
class ChangeRequestBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/changeRequest/${this.props.changeRequest.id}/dashboard`}>
  ...
  getChainCodeInvokerSearch = () => {
    ...
    return connect(state => ({
      ...
      data: state._changeRequest.chainCodeInvokerList,
      metaInfo: state._changeRequest.chainCodeInvokerListMetaInfo,
      count: state._changeRequest.chainCodeInvokerCount,
      returnURL: `/changeRequest/${state._changeRequest.id}/dashboard`,
      currentPage: state._changeRequest.chainCodeInvokerCurrentPageNumber,
      searchFormParameters: state._changeRequest.chainCodeInvokerSearchFormParameters,
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/changeRequest/:id/list/chainCodeInvokerList',
        component: this.getChainCodeInvokerSearch(),
      },
      {
        path: '/changeRequest/:id/list/chainCodeInvokerCreateForm',
        component: this.getChainCodeInvokerCreateForm(),
      },
      {
        path: '/changeRequest/:id/list/chainCodeInvokerUpdateForm',
        component: this.getChainCodeInvokerUpdateForm(),
      },
      {
        path: '/changeRequest/:id/ChangeRequestType/:code',
        ...
        <Layout style={{ marginTop: 44 }}>
          {this.state.showSearch && (
            <div style={{ backgroundColor: 'black' }} onClick={() => hideSearchResult()}>
              {searchLocalData(this.props.changeRequest, this.state.searchKeyword)}
            </div>
          )}
