...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/changeRequest/${targetComponent.props.changeRequest.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/changeRequest/${targetComponent.props.changeRequest.id}/permission`}>
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="创建时间">
        {moment(changeRequest.createTime).format('YYYY-MM-DD HH:mm')}
      </Description>
      <Description term="远程Ip" style={{ wordBreak: 'break-all' }}>
        {changeRequest.remoteIp}
      </Description>
      <Description term="请求类型">
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '请求类型',
              'changeRequestType',
              ChangeRequestService.requestCandidateRequestType,
              ChangeRequestService.transferToAnotherRequestType,
              'anotherRequestTypeId',
              changeRequest.requestType ? changeRequest.requestType.id : ''
            )
          }
...
class ChangeRequestDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '变更请求',
      cardsFor: 'changeRequest',
      cardsSource: this.props.changeRequest,
      returnURL,
      displayName,
      subItems: [
        {
