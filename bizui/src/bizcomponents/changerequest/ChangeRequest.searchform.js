  ...
  */
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'remoteIp')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'requestType')
      );
      pushIfNotNull(
        paramList,
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.remoteIp}>
            ...
            <Form.Item label={fieldLabels.network}>
              {getFieldDecorator('network', { initialValue: tryinit('network') })(
                <SelectObject
                  ...
                  targetType={'network'}
                  requestFunction={ChangeRequestService.requestCandidateNetwork}
                  useForSearch
                />
              )}
            </Form.Item>
