...
import styles from './TransactionStatus.updateform.less';
...
class TransactionStatusUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const transactionStatusId = values.id;
        const imagesValues = mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values, transactionStatusId, ...imagesValues };
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTransactionStatus`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1;
      dispatch({
        type: `${owner.type}/gotoNextTransactionStatusUpdateRow`,
        payload: {
          id: owner.id,
          type: 'transactionStatus',
          selectedRows,
    ...
    const internalRenderTitle = () => {
      ...
      return (
        <div>
          ...
          交易状态: {currentUpdateIndex + 1}/{selectedRows.length}
        </div>
      );
    };
...
}))(Form.create()(TransactionStatusUpdateForm));
