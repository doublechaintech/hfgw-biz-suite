...
import styles from './TransactionStatus.table.less';
import ImagePreview from '../../components/ImagePreview';
import GlobalComponents from '../../custcomponents';
import TransactionStatusBase from './TransactionStatus.base';
...
class TransactionStatusTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  };
  ...
  enhanceColumnsWithSorter = () => {
    const { displayColumns } = TransactionStatusBase;
      ...
      render: (text, record) => (
        <span>
          {hasReadPermission(metaInfo) && (
            <Link to={`/transactionStatus/${record.id}/dashboard`}>
