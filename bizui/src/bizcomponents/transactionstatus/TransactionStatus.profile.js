...
const internalSummaryOf = (item, targetComponents) => {
  return GlobalComponents.TransactionStatusBase.renderItemOfList(item, targetComponents);
};

class TransactionStatusProfile extends Component {
  componentDidMount() {}
...
}))(Form.create()(TransactionStatusProfile));
