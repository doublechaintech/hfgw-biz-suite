...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/formAction/${targetComponent.props.formAction.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/formAction/${targetComponent.props.formAction.id}/permission`}>
...
const internalSummaryOf = (formAction, targetComponent) => {
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="行动的关键" style={{ wordBreak: 'break-all' }}>
