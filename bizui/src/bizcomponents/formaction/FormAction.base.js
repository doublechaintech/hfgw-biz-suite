...
const menuData = {
  menuName: window.trans('form_action'),
  menuFor: 'formAction',
  subItems: [],
};
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'formAction'),
    sorter: true,
  },
  {
    ...
    <div key={formAction.id}>
      <DescriptionList key={formAction.id} size="small" col="2">
        ...
        <Description term={fieldLabels.localeKey} style={{ wordBreak: 'break-all' }}>
          {formAction.localeKey}
        </Description>
        <Description term={fieldLabels.actionKey} style={{ wordBreak: 'break-all' }}>
          {formAction.actionKey}
        </Description>
        <Description term={fieldLabels.level} style={{ wordBreak: 'break-all' }}>
          {formAction.level}
        </Description>
