...
const menuData = {
  menuName: window.trans('form_field'),
  menuFor: 'formField',
  subItems: [],
};
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'formField'),
    sorter: true,
  },
  {
    title: fieldLabels.label,
    debugtype: 'string',
    dataIndex: 'label',
    width: '7',
  ...
  {
    title: fieldLabels.defaultValue,
    debugtype: 'string',
  ...
  {
    title: fieldLabels.minimumValue,
    debugtype: 'string',
  ...
  {
    title: fieldLabels.maximumValue,
    debugtype: 'string',
  ...
  {
    title: fieldLabels.disabled,
    dataIndex: 'disabled',
    render: (text, record) => renderBooleanCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.customRendering,
    dataIndex: 'customRendering',
    render: (text, record) => renderBooleanCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.candidateValues,
    debugtype: 'string',
  ...
  {
    title: fieldLabels.suggestValues,
    debugtype: 'string',
  ...
  return (
    <div key={formField.id}>
      <DescriptionList key={formField.id} size="small" col="2">
        ...
        <Description term={fieldLabels.label} style={{ wordBreak: 'break-all' }}>
          {formField.label}
        </Description>
        <Description term={fieldLabels.localeKey} style={{ wordBreak: 'break-all' }}>
          {formField.localeKey}
        </Description>
        <Description term={fieldLabels.parameterName} style={{ wordBreak: 'break-all' }}>
          {formField.parameterName}
        </Description>
        <Description term={fieldLabels.type} style={{ wordBreak: 'break-all' }}>
          {formField.type}
        </Description>
        <Description term={fieldLabels.placeholder} style={{ wordBreak: 'break-all' }}>
          {formField.placeholder}
        </Description>
        <Description term={fieldLabels.defaultValue} style={{ wordBreak: 'break-all' }}>
          {formField.defaultValue}
        </Description>
        <Description term={fieldLabels.description} style={{ wordBreak: 'break-all' }}>
          {formField.description}
        </Description>
        <Description term={fieldLabels.fieldGroup} style={{ wordBreak: 'break-all' }}>
          {formField.fieldGroup}
        </Description>
        <Description term={fieldLabels.minimumValue} style={{ wordBreak: 'break-all' }}>
          {formField.minimumValue}
        </Description>
        <Description term={fieldLabels.maximumValue} style={{ wordBreak: 'break-all' }}>
          {formField.maximumValue}
        </Description>
        <Description term={fieldLabels.candidateValues} style={{ wordBreak: 'break-all' }}>
          {formField.candidateValues}
        </Description>
        <Description term={fieldLabels.suggestValues} style={{ wordBreak: 'break-all' }}>
          {formField.suggestValues}
        </Description>
      </DescriptionList>
