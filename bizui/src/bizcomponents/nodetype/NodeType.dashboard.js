...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/nodeType/${targetComponent.props.nodeType.id}/list/${item.name}/${item.displayName}/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/nodeType/${targetComponent.props.nodeType.id}/permission`}>
...
class NodeTypeDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '节点类型',
      cardsFor: 'nodeType',
      cardsSource: this.props.nodeType,
      returnURL,
      displayName,
      subItems: [
        {
