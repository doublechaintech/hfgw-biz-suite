...
import styles from './NodeType.search.less';
...
class NodeTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      nodeTypeList: 1,
      'nodeTypeList.searchField': fieldName,
      'nodeTypeList.searchVerb': 'startsWith',
      'nodeTypeList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          nodeTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(NodeTypeSearchForm);
