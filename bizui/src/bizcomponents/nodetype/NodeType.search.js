  ...
  return (
    <div>
      <HyperledgerNetworkAssociateForm
        ...
        data={{ nodeTypeList: selectedRows }}
        owner={owner}
...
class NodeTypeSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { NodeTypeTable } = GlobalComponents;
    const { NodeTypeSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this, NodeTypeModalTable, 'nodeTypeIds')}
...
export default Form.create()(NodeTypeSearch);
