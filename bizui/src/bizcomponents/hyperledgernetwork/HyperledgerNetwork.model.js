...
export default {
  ...
  effects: {
    ...
    *addOrganization({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/OrganizationList/组织+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateOrganization({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/OrganizationList/组织列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addChannel({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChannelList/频道+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateChannel({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChannelList/频道列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addApplication({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ApplicationList/应用程序+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateApplication({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ApplicationList/应用程序列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addServiceRecord({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ServiceRecordList/服务记录+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateServiceRecord({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ServiceRecordList/服务记录列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addChangeRequestType({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChangeRequestTypeList/变更请求类型+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateChangeRequestType({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChangeRequestTypeList/变更请求类型列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *removeChangeRequestTypeList({ payload }, { call, put }) {
     const userContext = null
      ...
      const { id, role, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(HyperledgerNetworkService.removeChangeRequestTypeList, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *addChangeRequest({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChangeRequestList/变更请求+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateChangeRequest({ payload }, { call, put }) {
      ...
      const location = { pathname: `/hyperledgerNetwork/${id}/list/ChangeRequestList/变更请求列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
