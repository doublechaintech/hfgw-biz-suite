...
class HyperledgerNetworkBizApp extends React.PureComponent {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/hyperledgerNetwork/${this.props.hyperledgerNetwork.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getOrganizationSearch = () => {
    ...
    return connect(state => ({
      ...
      listName: 'organizationList', ref:state._hyperledgerNetwork, 
  ...
  getOrganizationCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.organizationSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'organizationList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getOrganizationUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'organizationList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getChannelSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, 
      referenceName: 'network', 
      listName: 'channelList', ref:state._hyperledgerNetwork, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(ChannelSearch)
  }
  getChannelCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.channelSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'channelList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(ChannelCreateForm)
  }
  ...
  getChannelUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "channel",
      currentUpdateIndex: state._hyperledgerNetwork.currentUpdateIndex,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'channelList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(ChannelUpdateForm)
  }
  ...
  getApplicationSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, 
      referenceName: 'network', 
      listName: 'applicationList', ref:state._hyperledgerNetwork, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(ApplicationSearch)
  }
  getApplicationCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.applicationSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'applicationList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getApplicationUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "application",
      currentUpdateIndex: state._hyperledgerNetwork.currentUpdateIndex,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'applicationList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getServiceRecordSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, 
      referenceName: 'network', 
      listName: 'serviceRecordList', ref:state._hyperledgerNetwork, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(ServiceRecordSearch)
  }
  getServiceRecordCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.serviceRecordSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'serviceRecordList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getServiceRecordUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "serviceRecord",
      currentUpdateIndex: state._hyperledgerNetwork.currentUpdateIndex,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'serviceRecordList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getChangeRequestTypeSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, 
      referenceName: 'network', 
      listName: 'changeRequestTypeList', ref:state._hyperledgerNetwork, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getChangeRequestTypeCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.changeRequestTypeSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'changeRequestTypeList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getChangeRequestTypeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "changeRequestType",
      currentUpdateIndex: state._hyperledgerNetwork.currentUpdateIndex,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'changeRequestTypeList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getChangeRequestSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, 
      referenceName: 'network', 
      listName: 'changeRequestList', ref:state._hyperledgerNetwork, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(ChangeRequestSearch)
  }
  getChangeRequestCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._hyperledgerNetwork.changeRequestSearchFormParameters,
      loading: state._hyperledgerNetwork.loading,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, referenceName: 'network', listName: 'changeRequestList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getChangeRequestUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "changeRequest",
      currentUpdateIndex: state._hyperledgerNetwork.currentUpdateIndex,
      owner: { type: '_hyperledgerNetwork', id: state._hyperledgerNetwork.id, listName: 'changeRequestList', ref:state._hyperledgerNetwork, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/hyperledgerNetwork/:id/list/organizationList", component: this.getOrganizationSearch()},
  	...
  	{path:"/hyperledgerNetwork/:id/list/channelUpdateForm", component: this.getChannelUpdateForm()},
   	
  	{path:"/hyperledgerNetwork/:id/list/applicationList", component: this.getApplicationSearch()},
  	{path:"/hyperledgerNetwork/:id/list/applicationCreateForm", component: this.getApplicationCreateForm()},
  	{path:"/hyperledgerNetwork/:id/list/applicationUpdateForm", component: this.getApplicationUpdateForm()},
   	
  	{path:"/hyperledgerNetwork/:id/list/serviceRecordList", component: this.getServiceRecordSearch()},
  	{path:"/hyperledgerNetwork/:id/list/serviceRecordCreateForm", component: this.getServiceRecordCreateForm()},
  	{path:"/hyperledgerNetwork/:id/list/serviceRecordUpdateForm", component: this.getServiceRecordUpdateForm()},
   	
  	{path:"/hyperledgerNetwork/:id/list/changeRequestTypeList", component: this.getChangeRequestTypeSearch()},
  	{path:"/hyperledgerNetwork/:id/list/changeRequestTypeCreateForm", component: this.getChangeRequestTypeCreateForm()},
  	{path:"/hyperledgerNetwork/:id/list/changeRequestTypeUpdateForm", component: this.getChangeRequestTypeUpdateForm()},
   	
  	{path:"/hyperledgerNetwork/:id/list/changeRequestList", component: this.getChangeRequestSearch()},
  	{path:"/hyperledgerNetwork/:id/list/changeRequestCreateForm", component: this.getChangeRequestCreateForm()},
  	{path:"/hyperledgerNetwork/:id/list/changeRequestUpdateForm", component: this.getChangeRequestUpdateForm()},
   	{path:"/hyperledgerNetwork/:id/ChangeRequestType/:code", component: GlobalComponents.ChangeRequestStepForm},
