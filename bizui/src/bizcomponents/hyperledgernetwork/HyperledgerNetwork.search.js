...
class HyperledgerNetworkSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {HyperledgerNetworkTable} = GlobalComponents;
    const {HyperledgerNetworkSearchForm} = GlobalComponents;
    const {HyperledgerNetworkModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <HyperledgerNetworkSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,HyperledgerNetworkModalTable,"hyperledgerNetworkIds")}
...
export default Form.create()(HyperledgerNetworkSearch)
