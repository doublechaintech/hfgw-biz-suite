...
import styles from './HyperledgerNetwork.updateform.less';
...
class HyperledgerNetworkUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const hyperledgerNetworkId = values.id;
        const imagesValues = mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values, hyperledgerNetworkId, ...imagesValues };
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateHyperledgerNetwork`,
          payload: {
            id: owner.id,
            type: 'hyperledgerNetwork',
            parameters,
            selectedRows,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1;
      dispatch({
        type: `${owner.type}/gotoNextHyperledgerNetworkUpdateRow`,
        payload: {
          id: owner.id,
          type: 'hyperledgerNetwork',
          selectedRows,
    ...
    const internalRenderTitle = () => {
      ...
      return (
        <div>
          ...
          Hyperledger网络: {currentUpdateIndex + 1}/{selectedRows.length}
        </div>
      );
    };
    ...
    return (
      ...
      >
        ...
        <Card title={window.trans('hyperledger_network')} className={styles.card} bordered={false}>
          <Form>
            <Row gutter={16}>
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
...
}))(Form.create()(HyperledgerNetworkUpdateForm));
