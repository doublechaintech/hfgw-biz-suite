...
import styles from './HyperledgerNetwork.search.less';
...
class HyperledgerNetworkSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      hyperledgerNetworkList: 1,
      'hyperledgerNetworkList.searchField': fieldName,
      'hyperledgerNetworkList.searchVerb': 'startsWith',
      'hyperledgerNetworkList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          hyperledgerNetworkSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(HyperledgerNetworkSearchForm);
