...
const internalSettingListOf = hyperledgerNetwork =>
  defaultSettingListOf(hyperledgerNetwork, optionList);
const internalLargeTextOf = hyperledgerNetwork => {
  return (
    <div>
      <Card title={`描述`}>
        <pre>{hyperledgerNetwork.description}</pre>
      </Card>
    </div>
  );
};
...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/hyperledgerNetwork/${targetComponent.props.hyperledgerNetwork.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/hyperledgerNetwork/${targetComponent.props.hyperledgerNetwork.id}/permission`}>
...
class HyperledgerNetworkDashboard extends Component {
  ...
  render() {
    ...
    const {
      id,
      displayName,
      organizationListMetaInfo,
      nodeTypeListMetaInfo,
      nodeListMetaInfo,
      channelListMetaInfo,
      peerRoleListMetaInfo,
      applicationListMetaInfo,
      serviceRecordListMetaInfo,
      transactionStatusListMetaInfo,
      changeRequestTypeListMetaInfo,
      changeRequestListMetaInfo,
      organizationCount,
      nodeTypeCount,
      nodeCount,
      channelCount,
    ...
    const cardsData = {
      ...
      cardsSource: this.props.hyperledgerNetwork,
      returnURL,
      displayName,
      subItems: [
        {
          ...
          addFunction: true,
          role: 'organization',
          metaInfo: organizationListMetaInfo,
          renderItem: GlobalComponents.OrganizationBase.renderItemOfList,
        },
        {
          name: 'nodeList',
          displayName: '节点',
        ...
        },
        {
          ...
          addFunction: true,
          role: 'channel',
          metaInfo: channelListMetaInfo,
          renderItem: GlobalComponents.ChannelBase.renderItemOfList,
        },
        {
        ...
        },
        {
          ...
          addFunction: true,
          role: 'changeRequest',
          metaInfo: changeRequestListMetaInfo,
          renderItem: GlobalComponents.ChangeRequestBase.renderItemOfList,
        },
      ],
      subSettingItems: [
        {
        ...
        },
        {
          ...
          metaInfo: transactionStatusListMetaInfo,
        ...
        },
        {
          ...
          metaInfo: changeRequestTypeListMetaInfo,
