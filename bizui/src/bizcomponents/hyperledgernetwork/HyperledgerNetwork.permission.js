...
const renderPermissionSetting = hyperledgerNetwork => {
  ...
  return (
    <PermissionSetting
      targetObject={hyperledgerNetwork}
      targetObjectMeta={HyperledgerNetworkBase}
    />
  );
};
      ...
      subItems: [
        {
          ...
          addFunction: false,
          role: 'nodeType',
          data: hyperledgerNetwork.nodeTypeList,
        },
        {
          name: 'peerRoleList',
          displayName: '对等的角色',
          ...
          addFunction: false,
          role: 'peerRole',
          data: hyperledgerNetwork.peerRoleList,
        },
        {
          ...
          data: hyperledgerNetwork.transactionStatusList,
        },
        {
          ...
          data: hyperledgerNetwork.changeRequestTypeList,
        },
      ],
    };
