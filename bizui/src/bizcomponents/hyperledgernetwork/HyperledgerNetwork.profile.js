...
class HyperledgerNetworkProfile extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"Hyperledger网络",cardsFor: "hyperledgerNetwork",cardsSource: hyperledgerNetwork,displayName,returnURL,
  		subItems: [
{name: 'nodeTypeList', displayName:'节点类型',type:'nodeType',count:nodeTypeCount,addFunction: false, role: 'nodeType',  renderItem: GlobalComponents.NodeTypeBase.renderItemOfList},
