...
const internalSummaryOf = (item, targetComponents) => {
  return GlobalComponents.ChainCodeInvokerBase.renderItemOfList(item, targetComponents);
};

class ChainCodeInvokerProfile extends Component {
  componentDidMount() {}
...
}))(Form.create()(ChainCodeInvokerProfile));
