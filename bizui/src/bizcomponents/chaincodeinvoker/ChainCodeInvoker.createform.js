...
import ChainCodeInvokerCreateFormBody from './ChainCodeInvoker.createformbody';
...
class ChainCodeInvokerCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues };
        dispatch({
          type: `${owner.type}/addChainCodeInvoker`,
          payload: { id: owner.id, type: 'chainCodeInvoker', parameters, continueNext: true },
        });
      });
    };
    ...
    return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext, 'CreateNew')}${window.trans('chain_code_invoker')}`}
        wrapperClassName={styles.advancedForm}
      >
        <ChainCodeInvokerCreateFormBody {...this.props} />
...
}))(Form.create()(ChainCodeInvokerCreateForm));
