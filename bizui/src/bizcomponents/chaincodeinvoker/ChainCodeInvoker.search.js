  ...
  return (
    <div>
      <ApplicationAssociateForm
        ...
        data={{ chainCodeInvokerList: selectedRows }}
        owner={owner}
...
class ChainCodeInvokerSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { ChainCodeInvokerTable } = GlobalComponents;
    const { ChainCodeInvokerSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ChainCodeInvokerSearchForm {...this.props} />
            </div>
            <div className={styles.tableListOperator}>
        ...
        {showDeletionDialog(this, ChainCodeInvokerModalTable, 'chainCodeInvokerIds')}
...
export default Form.create()(ChainCodeInvokerSearch);
