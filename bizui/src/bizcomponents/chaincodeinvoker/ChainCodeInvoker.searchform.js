...
import styles from './ChainCodeInvoker.search.less';
...
class ChainCodeInvokerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      chainCodeInvokerList: 1,
      'chainCodeInvokerList.searchField': fieldName,
      'chainCodeInvokerList.searchVerb': 'startsWith',
      'chainCodeInvokerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'parameters')
      );
      pushIfNotNull(
        paramList,
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          chainCodeInvokerSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.parameters}>
...
export default Form.create()(ChainCodeInvokerSearchForm);
