...
const renderPermissionSetting = channelPeerRole => {
  const {ChannelPeerRoleBase} = GlobalComponents
  return <PermissionSetting targetObject={channelPeerRole}  targetObjectMeta={ChannelPeerRoleBase}/>
}

const internalRenderExtraHeader = defaultRenderExtraHeader

class ChannelPeerRolePermission extends Component {
...
}))(Form.create()(ChannelPeerRolePermission))
