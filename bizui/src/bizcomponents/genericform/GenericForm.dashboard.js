...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/genericForm/${targetComponent.props.genericForm.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/genericForm/${targetComponent.props.genericForm.id}/permission`}>
...
const internalSummaryOf = (genericForm, targetComponent) => {
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="标题" style={{ wordBreak: 'break-all' }}>
        {genericForm.title}
      </Description>
...
class GenericFormDashboard extends Component {
  ...
  render() {
    ...
    const {
      id,
      displayName,
      formMessageListMetaInfo,
      formFieldMessageListMetaInfo,
      formFieldListMetaInfo,
      formActionListMetaInfo,
      formMessageCount,
      ...
      subItems: [
        {
          ...
          addFunction: true,
          role: 'formMessage',
          metaInfo: formMessageListMetaInfo,
          renderItem: GlobalComponents.FormMessageBase.renderItemOfList,
        },
        {
          ...
          metaInfo: formFieldMessageListMetaInfo,
          renderItem: GlobalComponents.FormFieldMessageBase.renderItemOfList,
        },
        {
          name: 'formFieldList',
          displayName: '表单字段',
          ...
          addFunction: true,
          role: 'formField',
          metaInfo: formFieldListMetaInfo,
          renderItem: GlobalComponents.FormFieldBase.renderItemOfList,
        },
        {
          name: 'formActionList',
          displayName: '表单动作',
          ...
          addFunction: true,
          role: 'formAction',
          metaInfo: formActionListMetaInfo,
          renderItem: GlobalComponents.FormActionBase.renderItemOfList,
        },
      ],
      subSettingItems: [],
    };
