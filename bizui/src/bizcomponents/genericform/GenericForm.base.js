...
const menuData = {
  menuName: window.trans('generic_form'),
  menuFor: 'genericForm',
  subItems: [
    {
      name: 'formMessageList',
      displayName: window.mtrans('form_message', 'generic_form.form_message_list', false),
      type: 'formMessage',
      icon: 'wpforms',
    ...
    },
    {
      ...
      displayName: window.mtrans(
        'form_field_message',
        'generic_form.form_field_message_list',
        false
      ),
    ...
    {
      name: 'formFieldList',
      displayName: window.mtrans('form_field', 'generic_form.form_field_list', false),
      type: 'formField',
      icon: 'wpforms',
      readPermission: false,
      createPermission: false,
    ...
    {
      name: 'formActionList',
      displayName: window.mtrans('form_action', 'generic_form.form_action_list', false),
      type: 'formAction',
      icon: 'wpforms',
      readPermission: false,
      createPermission: false,
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'genericForm'),
    sorter: true,
  },
  {
