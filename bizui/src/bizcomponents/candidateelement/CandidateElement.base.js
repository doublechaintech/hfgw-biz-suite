...
const menuData = {
  menuName: window.trans('candidate_element'),
  menuFor: 'candidateElement',
  subItems: [],
};
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'candidateElement'),
    sorter: true,
  },
  {
  ...
  {
    title: fieldLabels.image,
    dataIndex: 'image',
    render: (text, record) => renderImageCell(text, record, 'candidate_element.image'),
  },
  {
    title: fieldLabels.container,
    dataIndex: 'container',
