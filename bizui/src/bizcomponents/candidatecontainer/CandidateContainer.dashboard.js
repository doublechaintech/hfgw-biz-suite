...
const internalSettingListOf = candidateContainer =>
  defaultSettingListOf(candidateContainer, optionList);
...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/candidateContainer/${targetComponent.props.candidateContainer.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/candidateContainer/${targetComponent.props.candidateContainer.id}/permission`}>
...
class CandidateContainerDashboard extends Component {
  ...
  render() {
    ...
    const {
      id,
      displayName,
      candidateElementListMetaInfo,
      candidateElementCount,
    } = this.props.candidateContainer;
    ...
    const cardsData = {
      cardsName: '候选人容器',
      cardsFor: 'candidateContainer',
      cardsSource: this.props.candidateContainer,
      returnURL,
      displayName,
      subItems: [
        {
          name: 'candidateElementList',
          displayName: '候选人元素',
          viewGroup: '__no_group',
          type: 'candidateElement',
          count: candidateElementCount,
          addFunction: true,
          role: 'candidateElement',
          metaInfo: candidateElementListMetaInfo,
          renderItem: GlobalComponents.CandidateElementBase.renderItemOfList,
        },
      ],
      subSettingItems: [],
    };
