...
class CandidateContainerBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/candidateContainer/${this.props.candidateContainer.id}/dashboard`}>
  ...
  getCandidateElementSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_candidateContainer',
        id: state._candidateContainer.id,
        referenceName: 'container',
        listName: 'candidateElementList',
        ref: state._candidateContainer,
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/candidateContainer/:id/list/candidateElementList',
        component: this.getCandidateElementSearch(),
      },
      {
        path: '/candidateContainer/:id/list/candidateElementCreateForm',
        component: this.getCandidateElementCreateForm(),
      },
      {
        path: '/candidateContainer/:id/list/candidateElementUpdateForm',
        component: this.getCandidateElementUpdateForm(),
      },
      {
        path: '/candidateContainer/:id/ChangeRequestType/:code',
        ...
        <Layout style={{ marginTop: 44 }}>
          {this.state.showSearch && (
            <div style={{ backgroundColor: 'black' }} onClick={() => hideSearchResult()}>
              {searchLocalData(this.props.candidateContainer, this.state.searchKeyword)}
            </div>
          )}
