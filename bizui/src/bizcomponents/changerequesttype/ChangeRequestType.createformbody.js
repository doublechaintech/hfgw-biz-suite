  ...
  render() {
    ...
    const internalRenderTitle = () => {
      ...
      return (
        <div>
          ...
          {window.trans('change_request_type')}
        </div>
      );
    };
    ...
    return (
      <div>
        ...
        <Card title={fieldLabels.bindTypes} className={styles.card} bordered={false}>
          <Form>
            <Row gutter={16}>
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
        ...
        <Card title={fieldLabels.stepConfiguration} className={styles.card} bordered={false}>
          <Form>
            <Row gutter={16}>
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
