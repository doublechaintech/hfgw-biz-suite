  ...
  render() {
    ...
    const internalRenderTitle = () => {
      ...
      return (
        <div>
          ...
          变更请求类型: {currentUpdateIndex + 1}/{selectedRows.length}
        </div>
      );
    };
    ...
    return (
      ...
      >
        ...
        <Card title={window.trans('change_request_type')} className={styles.card} bordered={false}>
          <Form>
            <Row gutter={16}>
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
                  {getFieldDecorator('bindTypes', {
                    initialValue: selectedRow.bindTypes,
                    rules: [{ required: true, message: appLocaleName(userContext, 'PleaseInput') }],
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
                  {getFieldDecorator('stepConfiguration', {
                    initialValue: selectedRow.stepConfiguration,
                    rules: [{ required: true, message: appLocaleName(userContext, 'PleaseInput') }],
                  })(<TextArea rows={4} placeholder={appLocaleName(userContext, 'PleaseInput')} />)}
                </Form.Item>
              </Col>
