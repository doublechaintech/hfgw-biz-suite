...
class ApplicationBizApp extends React.PureComponent {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/application/${this.props.application.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getServiceRecordSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_application', id: state._application.id, 
      referenceName: 'application', 
      listName: 'serviceRecordList', ref:state._application, 
  ...
  getServiceRecordCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._application.serviceRecordSearchFormParameters,
      loading: state._application.loading,
      owner: { type: '_application', id: state._application.id, referenceName: 'application', listName: 'serviceRecordList', ref:state._application, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getServiceRecordUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_application', id: state._application.id, listName: 'serviceRecordList', ref:state._application, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/application/:id/list/serviceRecordCreateForm", component: this.getServiceRecordCreateForm()},
  	{path:"/application/:id/list/serviceRecordUpdateForm", component: this.getServiceRecordUpdateForm()},
   	{path:"/application/:id/ChangeRequestType/:code", component: GlobalComponents.ChangeRequestStepForm},
