...
import styles from './Application.search.less'
...
class ApplicationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      applicationList: 1,
      'applicationList.searchField': fieldName,
      'applicationList.searchVerb': 'startsWith',
      'applicationList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'mspid'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'publicKey'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'privateKey'))
      ...
      dispatch({
        ...
        applicationSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"channel"} 
                    requestFunction={ApplicationService.requestCandidateChannel} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"network"} 
                    requestFunction={ApplicationService.requestCandidateNetwork} useForSearch />
...
export default Form.create()(ApplicationSearchForm)
