...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/userApp/${targetComponent.props.userApp.id}/list/${item.name}/${item.displayName}/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/userApp/${targetComponent.props.userApp.id}/permission`}>
...
const internalSummaryOf = (userApp, targetComponent) => {
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="应用程序图标" style={{ wordBreak: 'break-all' }}>
        {userApp.appIcon}
      </Description>
      <Description term="许可" style={{ wordBreak: 'break-all' }}>
        {userApp.permission}
      </Description>
      <Description term="访问对象类型" style={{ wordBreak: 'break-all' }}>
        {userApp.objectType}
      </Description>
      <Description term="对象ID" style={{ wordBreak: 'break-all' }}>
        {userApp.objectId}
      </Description>
      <Description term="位置" style={{ wordBreak: 'break-all' }}>
        {userApp.location}
      </Description>
      ...
      subItems: [
        {
          ...
          addFunction: true,
          role: 'quickLink',
          metaInfo: quickLinkListMetaInfo,
          renderItem: GlobalComponents.QuickLinkBase.renderItemOfList,
        },
        {
          name: 'listAccessList',
          displayName: '访问列表',
