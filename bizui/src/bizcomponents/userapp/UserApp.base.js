...
const menuData = {
  menuName: window.trans('user_app'),
  menuFor: 'userApp',
  subItems: [
    {
      name: 'quickLinkList',
      displayName: window.mtrans('quick_link', 'user_app.quick_link_list', false),
      type: 'quickLink',
      icon: 'link',
    ...
    {
      name: 'listAccessList',
      displayName: window.mtrans('list_access', 'user_app.list_access_list', false),
      type: 'listAccess',
      icon: 'list',
      readPermission: false,
      createPermission: false,
    ...
    },
    {
      ...
      displayName: window.mtrans('object_access', 'user_app.object_access_list', false),
      type: 'objectAccess',
  ...
  return (
    <div key={userApp.id}>
      <DescriptionList key={userApp.id} size="small" col="2">
        ...
        <Description term={fieldLabels.title} style={{ wordBreak: 'break-all' }}>
          {userApp.title}
        </Description>
        ...
        <Description term={fieldLabels.appIcon} style={{ wordBreak: 'break-all' }}>
          {userApp.appIcon}
        </Description>
        <Description term={fieldLabels.permission} style={{ wordBreak: 'break-all' }}>
          {userApp.permission}
        </Description>
        <Description term={fieldLabels.objectType} style={{ wordBreak: 'break-all' }}>
          {userApp.objectType}
        </Description>
        <Description term={fieldLabels.objectId} style={{ wordBreak: 'break-all' }}>
          {userApp.objectId}
        </Description>
        <Description term={fieldLabels.location} style={{ wordBreak: 'break-all' }}>
          {userApp.location}
        </Description>
      </DescriptionList>
