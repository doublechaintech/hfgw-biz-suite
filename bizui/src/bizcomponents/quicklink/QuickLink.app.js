...
class QuickLinkBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/quickLink/${this.props.quickLink.id}/dashboard`}>
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/quickLink/:id/ChangeRequestType/:code',
        ...
        <Layout style={{ marginTop: 44 }}>
          {this.state.showSearch && (
            <div style={{ backgroundColor: 'black' }} onClick={() => hideSearchResult()}>
              {searchLocalData(this.props.quickLink, this.state.searchKeyword)}
            </div>
          )}
