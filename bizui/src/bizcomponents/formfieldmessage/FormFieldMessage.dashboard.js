...
const internalSettingListOf = formFieldMessage =>
  defaultSettingListOf(formFieldMessage, optionList);
...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/formFieldMessage/${targetComponent.props.formFieldMessage.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/formFieldMessage/${targetComponent.props.formFieldMessage.id}/permission`}>
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="标题" style={{ wordBreak: 'break-all' }}>
        {formFieldMessage.title}
      </Description>
      <Description term="参数名称" style={{ wordBreak: 'break-all' }}>
        {formFieldMessage.parameterName}
      </Description>
      <Description term="水平" style={{ wordBreak: 'break-all' }}>
        {formFieldMessage.level}
      </Description>
