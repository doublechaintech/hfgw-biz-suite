...
import styles from './TlsCacert.search.less'
...
class TlsCacertSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      tlsCacertList: 1,
      'tlsCacertList.searchField': fieldName,
      'tlsCacertList.searchVerb': 'startsWith',
      'tlsCacertList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'path'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'cert'))
      ...
      dispatch({
        ...
        tlsCacertSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"node"} 
                    requestFunction={TlsCacertService.requestCandidateNode} useForSearch />
...
export default Form.create()(TlsCacertSearchForm)
