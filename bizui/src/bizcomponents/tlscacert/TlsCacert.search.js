...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{tlsCacertList:selectedRows}} owner={owner}  
...
class TlsCacertSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TlsCacertTable} = GlobalComponents;
    const {TlsCacertSearchForm} = GlobalComponents;
    const {TlsCacertModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TlsCacertSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TlsCacertModalTable,"tlsCacertIds")}
...
export default Form.create()(TlsCacertSearch)
