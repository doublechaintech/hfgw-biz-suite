...
import styles from './Channel.search.less';
...
class ChannelSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      channelList: 1,
      'channelList.searchField': fieldName,
      'channelList.searchVerb': 'startsWith',
      'channelList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          channelSearchFormParameters: filterObjectKeys(fieldsValue),
            ...
            <Form.Item label={fieldLabels.network}>
              {getFieldDecorator('network', { initialValue: tryinit('network') })(
                <SelectObject
                  ...
                  targetType={'network'}
                  requestFunction={ChannelService.requestCandidateNetwork}
                  useForSearch
                />
              )}
            </Form.Item>
...
export default Form.create()(ChannelSearchForm);
