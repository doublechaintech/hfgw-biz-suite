...
class ChannelSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { ChannelTable } = GlobalComponents;
    const { ChannelSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this, ChannelModalTable, 'channelIds')}
...
export default Form.create()(ChannelSearch);
