  ...
  return (
    <div>
      <NodeAssociateForm
        ...
        data={{ grpcOptionList: selectedRows }}
        owner={owner}
...
class GrpcOptionSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { GrpcOptionTable } = GlobalComponents;
    const { GrpcOptionSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <GrpcOptionSearchForm {...this.props} />
            </div>
            <div className={styles.tableListOperator}>
        ...
        {showDeletionDialog(this, GrpcOptionModalTable, 'grpcOptionIds')}
...
export default Form.create()(GrpcOptionSearch);
