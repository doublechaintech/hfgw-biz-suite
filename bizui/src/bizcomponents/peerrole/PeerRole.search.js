  ...
  return (
    <div>
      <HyperledgerNetworkAssociateForm
        ...
        data={{ peerRoleList: selectedRows }}
        owner={owner}
...
class PeerRoleSearch extends PureComponent {
  state = {
  ...
  render() {
    ...
    const { PeerRoleTable } = GlobalComponents;
    const { PeerRoleSearchForm } = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this, PeerRoleModalTable, 'peerRoleIds')}
...
export default Form.create()(PeerRoleSearch);
