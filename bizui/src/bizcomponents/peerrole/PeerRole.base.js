...
const menuData = {menuName:"对等的角色", menuFor: "peerRole",
  		subItems: [
...
const settingMenuData = {menuName:"对等的角色", menuFor: "peerRole",
  		subItems: [
...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '8', render: (text, record)=>renderTextCell(text,record,'peerRole') , sorter: true },
