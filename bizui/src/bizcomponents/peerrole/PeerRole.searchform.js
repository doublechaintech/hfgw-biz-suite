...
class PeerRoleSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      peerRoleList: 1,
      'peerRoleList.searchField': fieldName,
      'peerRoleList.searchVerb': 'startsWith',
      'peerRoleList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          peerRoleSearchFormParameters: filterObjectKeys(fieldsValue),
            ...
            <Form.Item label={fieldLabels.network}>
              {getFieldDecorator('network', { initialValue: tryinit('network') })(
                <SelectObject
                  ...
                  targetType={'network'}
                  requestFunction={PeerRoleService.requestCandidateNetwork}
                  useForSearch
                />
              )}
            </Form.Item>
...
export default Form.create()(PeerRoleSearchForm);
