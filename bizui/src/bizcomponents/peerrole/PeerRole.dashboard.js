...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/peerRole/${targetComponent.props.peerRole.id}/list/${item.name}/${item.displayName}/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/peerRole/${targetComponent.props.peerRole.id}/permission`}>
...
class PeerRoleDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '对等的角色',
      cardsFor: 'peerRole',
      cardsSource: this.props.peerRole,
      returnURL,
      displayName,
      subItems: [
        {
