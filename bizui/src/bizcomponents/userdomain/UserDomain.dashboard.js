...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/userDomain/${targetComponent.props.userDomain.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/userDomain/${targetComponent.props.userDomain.id}/permission`}>
      ...
      subSettingItems: [
        {
          ...
          addFunction: true,
          role: 'userWhiteList',
          metaInfo: userWhiteListListMetaInfo,
