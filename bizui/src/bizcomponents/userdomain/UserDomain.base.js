...
const menuData = {
  menuName: window.trans('user_domain'),
  menuFor: 'userDomain',
  subItems: [
    {
      name: 'secUserList',
      displayName: window.mtrans('sec_user', 'user_domain.sec_user_list', false),
      type: 'secUser',
      icon: 'user',
  ...
  subItems: [
    {
      ...
      displayName: window.mtrans('user_white_list', 'user_domain.user_white_list_list', false),
      type: 'userWhiteList',
      icon: 'list',
      readPermission: false,
      createPermission: false,
