...
import com.doublechaintech.hfgw.HfgwUserContextImpl;
import com.doublechaintech.hfgw.LoginForm;
import com.doublechaintech.hfgw.BaseEntity;
import com.doublechaintech.hfgw.CommonError;
import com.doublechaintech.hfgw.DAOGroup;
import com.doublechaintech.hfgw.ManagerGroup;

import com.doublechaintech.hfgw.UserContextImpl;
import com.doublechaintech.hfgw.userapp.UserApp;
import com.doublechaintech.hfgw.HfgwUserContext;
import com.doublechaintech.hfgw.userapp.*;
import com.doublechaintech.hfgw.listaccess.*;
import com.doublechaintech.hfgw.objectaccess.*;
import com.doublechaintech.hfgw.HfgwObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(HfgwUserContext userContext){
    ...
    public Object resetPassword(HfgwUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(HfgwUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(HfgwUserContext userContext,
    ...
    public SecUser manage(HfgwUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(HfgwUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(HfgwUserContext userContext) {
    ...
    protected Object gotoApp(HfgwUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(HfgwUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(HfgwUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(HfgwUserContext userContex, int length){
    ...
    protected String getBeanName(HfgwUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(HfgwUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(HfgwUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(HfgwUserContext userContext, UserApp app){
    ...
    public Object home(HfgwUserContext userContext) {
    ...
    public Object loginWithEmail(HfgwUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(HfgwUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(HfgwUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(HfgwUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(HfgwUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(HfgwUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(HfgwUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(HfgwUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(HfgwUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        HfgwUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected HfgwObjectChecker checker;
    public HfgwObjectChecker getChecker(){
        return checker;
    }
    
    public void setChecker(HfgwObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((HfgwObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected HfgwUserContextImpl createNewConext(String path) {

        return new HfgwUserContextImpl();
    ...
    public Object checkOtherLogin(HfgwUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(HfgwUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(HfgwUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(HfgwUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(HfgwUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(HfgwUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(HfgwUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(HfgwUserContext userContext) throws SecUserManagerException {
