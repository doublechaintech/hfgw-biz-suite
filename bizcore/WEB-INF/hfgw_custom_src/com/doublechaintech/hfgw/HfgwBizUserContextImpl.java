...
public class HfgwBizUserContextImpl extends HfgwUserContextImpl{
	...
	protected BaseHfgwFormProcessor inputFormData;
	protected BaseHfgwFormProcessor outputFormData;
	...
	public String getPostMd5Key(HfgwBizUserContextImpl ctx) {
	...
	public BaseHfgwFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseHfgwFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseHfgwFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseHfgwFormProcessor outputFormData) {
