...
public class SecUserBlockingManagerImpl extends CustomHfgwCheckerManager implements SecUserBlockingManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserBlockingManagerException{
 	...
 	protected SecUserBlocking saveSecUserBlocking(HfgwUserContext userContext, SecUserBlocking secUserBlocking, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUserBlocking saveSecUserBlockingDetail(HfgwUserContext userContext, SecUserBlocking secUserBlocking) throws Exception{	
 	...
 	public SecUserBlocking loadSecUserBlocking(HfgwUserContext userContext, String secUserBlockingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUserBlocking searchSecUserBlocking(HfgwUserContext userContext, String secUserBlockingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUserBlocking present(HfgwUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUserBlocking loadSecUserBlockingDetail(HfgwUserContext userContext, String secUserBlockingId) throws Exception{	
 	...
 	public Object view(HfgwUserContext userContext, String secUserBlockingId) throws Exception{	
 		SecUserBlocking secUserBlocking = loadSecUserBlocking( userContext, secUserBlockingId, viewTokens());
 		return present(userContext,secUserBlocking, allTokens());
		
 	}
 	protected SecUserBlocking saveSecUserBlocking(HfgwUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object>tokens) throws Exception{	
 		return secUserBlockingDaoOf(userContext).save(secUserBlocking, tokens);
 	}
 	protected SecUserBlocking loadSecUserBlocking(HfgwUserContext userContext, String secUserBlockingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSecUserBlocking(secUserBlockingId);
		checkerOf(userContext).throwExceptionIfHasErrors( SecUserBlockingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, SecUserBlocking secUserBlocking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUserBlocking(HfgwUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUserBlocking clone(HfgwUserContext userContext, String fromSecUserBlockingId) throws Exception{
	...
	public SecUserBlocking internalSaveSecUserBlocking(HfgwUserContext userContext, SecUserBlocking secUserBlocking, Map<String,Object> options) throws Exception 
	{
	...
	public SecUserBlocking updateSecUserBlockingProperty(HfgwUserContext userContext,String secUserBlockingId, int secUserBlockingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUserBlocking(userContext, secUserBlockingId, secUserBlockingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(HfgwUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
	...
	public SecUserBlocking forgetByAll(HfgwUserContext userContext, String secUserBlockingId, int secUserBlockingVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserBlockingId, secUserBlockingVersion);		
	}
	protected SecUserBlocking forgetByAllInternal(HfgwUserContext userContext,
			String secUserBlockingId, int secUserBlockingVersion) throws Exception{
	...
	protected SecUserBlocking breakWithSecUserByDomain(HfgwUserContext userContext, String secUserBlockingId, String domainId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingSecUser(HfgwUserContext userContext, String secUserBlockingId, String login, String mobile, String email, String pwd, String weixinOpenid, String weixinAppid, String accessToken, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(HfgwUserContext userContext, String secUserBlockingId,String id,String login,String mobile,String email,String pwd,String weixinOpenid,String weixinAppid,String accessToken,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUserBlocking updateSecUserProperties(HfgwUserContext userContext, String secUserBlockingId, String id,String login,String mobile,String email,String pwd,String weixinOpenid,String weixinAppid,String accessToken,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(HfgwUserContext userContext, String login, String mobile, String email, String pwd, String weixinOpenid, String weixinAppid, String accessToken, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime, String domainId) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(HfgwUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUserList(HfgwUserContext userContext, String secUserBlockingId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(HfgwUserContext userContext, String secUserBlockingId, 
	...
	public  SecUserBlocking removeSecUser(HfgwUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(HfgwUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking copySecUserFrom(HfgwUserContext userContext, String secUserBlockingId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(HfgwUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUserBlocking updateSecUser(HfgwUserContext userContext, String secUserBlockingId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
