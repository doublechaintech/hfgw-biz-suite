...
public class HfgwNamingServiceDAO extends CommonJDBCTemplateDAO {

	private static Map<String, String[]>namingTableMap;
	static {
		namingTableMap = new HashMap<String, String[]>();
		namingTableMap.put("HyperledgerNetwork", new String[]{"hyperledger_network_data","name"});
		namingTableMap.put("Organization", new String[]{"organization_data","name"});
