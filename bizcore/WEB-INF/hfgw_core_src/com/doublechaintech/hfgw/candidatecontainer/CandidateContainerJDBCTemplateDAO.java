...
public class CandidateContainerJDBCTemplateDAO extends HfgwBaseDAOImpl implements CandidateContainerDAO{
	...
	*/
    ...
    public SmartList<CandidateContainer> requestCandidateCandidateContainerForCandidateElement(HfgwUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CandidateElement> loadOurCandidateElementList(HfgwUserContext userContext, List<CandidateContainer> us, Map<String,Object> options) throws Exception{
