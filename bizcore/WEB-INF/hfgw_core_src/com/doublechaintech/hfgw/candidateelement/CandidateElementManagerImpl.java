...
import com.doublechaintech.hfgw.candidatecontainer.CandidateCandidateContainer;
...
public class CandidateElementManagerImpl extends CustomHfgwCheckerManager implements CandidateElementManager {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(HfgwUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateElement saveCandidateElementDetail(HfgwUserContext userContext, CandidateElement candidateElement) throws Exception{	
 	...
 	public CandidateElement loadCandidateElement(HfgwUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateElement searchCandidateElement(HfgwUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateElement present(HfgwUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(HfgwUserContext userContext, String candidateElementId) throws Exception{	
 	...
 	public Object view(HfgwUserContext userContext, String candidateElementId) throws Exception{	
 		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 		return present(userContext,candidateElement, allTokens());
		
 	}
 	protected CandidateElement saveCandidateElement(HfgwUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(HfgwUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateElementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateElement(HfgwUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(HfgwUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(HfgwUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception 
	{
	...
	public CandidateElement updateCandidateElementProperty(HfgwUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(HfgwUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(HfgwUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(HfgwUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(HfgwUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
	...
	public CandidateElement forgetByAll(HfgwUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);		
	}
	protected CandidateElement forgetByAllInternal(HfgwUserContext userContext,
			String candidateElementId, int candidateElementVersion) throws Exception{
