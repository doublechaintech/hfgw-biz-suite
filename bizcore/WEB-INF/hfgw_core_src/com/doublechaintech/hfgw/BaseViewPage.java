...
public abstract class BaseViewPage extends HashMap<String, Object> {
	...
	public void assemblerContent(HfgwUserContext userContext, String requestName) throws Exception {
		setPageTitle("尚未实现");
	}
	public Map<String, Object> doRender(HfgwUserContext userContext) {
	...
	protected CustomSerializer getCustomSerializerByObject(Object object) {
		...
		if (object instanceof BaseHfgwFormProcessor) {
	...
	protected class FormProcessorSerializer implements CustomSerializer {
		@Override
		public Object serialize(SerializeScope serializeScope, Object value, String path) {
			BaseHfgwFormProcessor form = (BaseHfgwFormProcessor) value;
			if (form == null) {
				return null;
			}
