...
public class ChangeRequestMapper extends BaseRowMapper<ChangeRequest>{
	...
	protected ChangeRequest internalMapRow(ResultSet rs, int rowNumber) throws SQLException{
		ChangeRequest changeRequest = getChangeRequest();		
 		...
 		setNetwork(changeRequest, rs, rowNumber); 		
	...
	protected void setRemoteIp(ChangeRequest changeRequest, ResultSet rs, int rowNumber) throws SQLException{
 	...
 	protected void setNetwork(ChangeRequest changeRequest, ResultSet rs, int rowNumber) throws SQLException{
 		String hyperledgerNetworkId = rs.getString(ChangeRequestTable.COLUMN_NETWORK);
 		...
 		HyperledgerNetwork hyperledgerNetwork = changeRequest.getNetwork();
 		...
 		changeRequest.setNetwork(createEmptyNetwork(hyperledgerNetworkId));
 	}
