...
public class ServiceRecordTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_PAYLOAD,COLUMN_CHANNEL,COLUMN_CHAIN_CODE,COLUMN_CHAIN_CODE_FUNCTION,COLUMN_TRANSACTION_ID,COLUMN_BLOCK_ID,COLUMN_CREATE_TIME,COLUMN_APP_CLIENT,COLUMN_NETWORK,COLUMN_RESPONSE,COLUMN_STATUS,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_PAYLOAD,COLUMN_CHANNEL,COLUMN_CHAIN_CODE,COLUMN_CHAIN_CODE_FUNCTION,COLUMN_TRANSACTION_ID,COLUMN_BLOCK_ID,COLUMN_CREATE_TIME,COLUMN_APP_CLIENT,COLUMN_NETWORK,COLUMN_RESPONSE,COLUMN_STATUS};
