...
@JsonSerialize(using = HfgwExceptionJsonSerializer.class)
public class HfgwException extends Exception implements MessageContainer {
    ...
    public HfgwException() {
        super();
    }
    
	
    public HfgwException(String message) {
        super(message);
    }
    public HfgwException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public HfgwException(List<Message> messageList) {
        super();
    ...
    public HfgwException(String message, Throwable cause) {
        super(message, cause);
    }


    public HfgwException(Throwable cause) {
        super(cause);
    }
