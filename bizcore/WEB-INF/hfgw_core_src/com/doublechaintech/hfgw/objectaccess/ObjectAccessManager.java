...
public interface ObjectAccessManager{
	...
	public ObjectAccess internalSaveObjectAccess(HfgwUserContext userContext, ObjectAccess objectAccess,Map<String,Object>option) throws Exception;
	...
	public void delete(HfgwUserContext userContext, String objectAccessId, int version) throws Exception;
