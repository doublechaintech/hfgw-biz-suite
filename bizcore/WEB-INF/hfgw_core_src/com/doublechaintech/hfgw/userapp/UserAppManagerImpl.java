...
public class UserAppManagerImpl extends CustomHfgwCheckerManager implements UserAppManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(HfgwUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(HfgwUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(HfgwUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(HfgwUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(HfgwUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(HfgwUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(HfgwUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(HfgwUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userAppDaoOf(userContext).save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(HfgwUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUserApp(userAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(HfgwUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(HfgwUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(HfgwUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception 
	{
	...
	public UserApp updateUserAppProperty(HfgwUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(HfgwUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(HfgwUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(HfgwUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(HfgwUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(HfgwUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(HfgwUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(HfgwUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(HfgwUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(HfgwUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);		
	}
	protected UserApp forgetByAllInternal(HfgwUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingQuickLink(HfgwUserContext userContext, String userAppId, String name, String icon, String imagePath, String linkTarget,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingQuickLinkProperties(HfgwUserContext userContext, String userAppId,String id,String name,String icon,String imagePath,String linkTarget,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateQuickLinkProperties(HfgwUserContext userContext, String userAppId, String id,String name,String icon,String imagePath,String linkTarget, String [] tokensExpr) throws Exception
	{	
	...
	protected QuickLink createQuickLink(HfgwUserContext userContext, String name, String icon, String imagePath, String linkTarget) throws Exception{
	...
	protected void checkParamsForRemovingQuickLinkList(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeQuickLinkList(HfgwUserContext userContext, String userAppId, 
			String quickLinkIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingQuickLink(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeQuickLink(HfgwUserContext userContext, String userAppId, 
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingQuickLink(HfgwUserContext userContext, String userAppId, 
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyQuickLinkFrom(HfgwUserContext userContext, String userAppId, 
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingQuickLink(HfgwUserContext userContext, String userAppId, String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateQuickLink(HfgwUserContext userContext, String userAppId, String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingListAccess(HfgwUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccessProperties(HfgwUserContext userContext, String userAppId,String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateListAccessProperties(HfgwUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{	
	...
	protected ListAccess createListAccess(HfgwUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccessList(HfgwUserContext userContext, String userAppId, 
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccess(HfgwUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(HfgwUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(HfgwUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(HfgwUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(HfgwUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingObjectAccess(HfgwUserContext userContext, String userAppId, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccessProperties(HfgwUserContext userContext, String userAppId,String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateObjectAccessProperties(HfgwUserContext userContext, String userAppId, String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9, String [] tokensExpr) throws Exception
	{	
	...
	protected ObjectAccess createObjectAccess(HfgwUserContext userContext, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccessList(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccessList(HfgwUserContext userContext, String userAppId, 
			String objectAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccess(HfgwUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccess(HfgwUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingObjectAccess(HfgwUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyObjectAccessFrom(HfgwUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccess(HfgwUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccess(HfgwUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
