...
import com.doublechaintech.hfgw.secuserblocking.CandidateSecUserBlocking;
...
public class SecUserManagerImpl extends CustomHfgwCheckerManager implements SecUserManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(HfgwUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(HfgwUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(HfgwUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(HfgwUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(HfgwUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(HfgwUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(HfgwUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(HfgwUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return secUserDaoOf(userContext).save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(HfgwUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSecUser(secUserId);
		checkerOf(userContext).throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(HfgwUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HfgwUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(HfgwUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(HfgwUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(HfgwUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception 
	{
	...
	public SecUser updateSecUserProperty(HfgwUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	public CandidateUserDomain requestCandidateDomain(HfgwUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBlocking(HfgwUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
 	...
 	public SecUser transferToAnotherBlocking(HfgwUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
	...
	public CandidateSecUserBlocking requestCandidateBlocking(HfgwUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected SecUserBlocking loadSecUserBlocking(HfgwUserContext userContext, String newBlockingId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(HfgwUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(HfgwUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);		
	}
	protected SecUser forgetByAllInternal(HfgwUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(HfgwUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(HfgwUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(HfgwUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(HfgwUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{	
	...
	protected UserApp createUserApp(HfgwUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(HfgwUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserAppList(HfgwUserContext userContext, String secUserId, 
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(HfgwUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserApp(HfgwUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(HfgwUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(HfgwUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(HfgwUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(HfgwUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(HfgwUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(HfgwUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(HfgwUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{	
	...
	protected LoginHistory createLoginHistory(HfgwUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(HfgwUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistoryList(HfgwUserContext userContext, String secUserId, 
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(HfgwUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistory(HfgwUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(HfgwUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(HfgwUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(HfgwUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(HfgwUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
