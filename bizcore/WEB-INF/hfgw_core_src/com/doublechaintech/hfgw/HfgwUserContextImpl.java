...
import com.doublechaintech.hfgw.secuser.SecUserCustomManagerImpl;
...
public class HfgwUserContextImpl extends UserContextImpl implements HfgwUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.hfgw.HfgwResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.hfgw.HfgwCustomResources";
    ...
    /*
    public static SecUser getSecUser(HfgwUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(HfgwUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(HfgwUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(HfgwUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private HfgwObjectChecker checker;
