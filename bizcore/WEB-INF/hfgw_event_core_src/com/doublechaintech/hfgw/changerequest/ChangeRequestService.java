...
public class ChangeRequestService extends CustomHfgwCheckerManager{
	
	
	
	public ChangeRequest save(HfgwUserContext userContext, ChangeRequest request) throws Exception {
	...
	public ChangeRequest process(HfgwUserContext userContext, ChangeRequest request) throws Exception {
	...
	protected void saveChangeRequest(HfgwUserContext userContext,ChangeRequest request) throws Exception{
		this.changeRequestManagerOf(userContext).internalSaveChangeRequest(userContext, request);
	}
	
	protected String calcBeanNameFor(HfgwUserContext userContext,String type) {
	...
	protected ChangeRequestBaseHandler calcHandlerFor(HfgwUserContext userContext,ChangeRequest request){
		String type = request.getRequestType().getId();
		if(type == null) {
